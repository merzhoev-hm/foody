...
function calc() {
  ...
  var gender, height, weight, age, ratio;
...
function cards(params) {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(src, alt, title, desc, price, parentSelector) {
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modal */ "./js/modules/modal.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (e) {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_11__.postData)("http://localhost:3000/requests", json).then(function (data) {
        console.log(data);
        ...
        form.reset();
        // const spinsvg = document.querySelector(".modal__content img").remove();
      });
    });
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_10__.openModal)('.modal', modalTimerId);
    var thanksModal = document.createElement("div");
    thanksModal.classList.add("modal__dialog");
    thanksModal.innerHTML = "\n  <div class='modal__content'>\n      <div data-close class=\"modal__close\">\xD7</div>\n      <div class=\"modal__title\">".concat(message, "</div>\n  </div>\n  ");
    document.querySelector('.modal').append(thanksModal);
    setTimeout(function () {
      thanksModal.remove();
      prevModalDialog.classList.add('show');
      prevModalDialog.classList.remove('hide');
      (0,_modal__WEBPACK_IMPORTED_MODULE_10__.closeModal)('.modal');
    }, 4000);
  }
}
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  var tabsParent = document.querySelector(tabsParentSelector);
...
(0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2024-06-17');
